        ...
        <div style={{
          ...
          <div className="card" style={{
                ...
                <tbody>
                  {selectedOrder.items?.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td style={{padding: '8px 10px', textAlign: 'left', borderBottom: '1px solid #eee'}}>${(item.price * item.quantity).toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div style={{marginBottom: '20px'}}>
              ...
              <table style={{width: '100%', borderCollapse: 'collapse'}}>
                <tbody>
                  <tr><td style={{padding: '6px 10px', fontWeight: '600', width: '120px'}}>المجموع الفرعي:</td><td style={{padding: '6px 10px'}}>${selectedOrder.pricing?.subtotal?.toFixed(2)}</td></tr>
                  <tr><td style={{padding: '6px 10px', fontWeight: '600'}}>رسوم التوصيل:</td><td style={{padding: '6px 10px'}}>${selectedOrder.pricing?.shippingFee?.toFixed(2)}</td></tr>
                  <tr style={{fontWeight: 'bold', fontSize: '18px'}}><td style={{padding: '6px 10px', borderTop: '2px solid #333'}}>الإجمالي:</td><td style={{padding: '6px 10px', borderTop: '2px solid #333', color: '#27ae60'}}>${selectedOrder.pricing?.total?.toFixed(2)}</td></tr>
                </tbody>
              </table>
            </div>
